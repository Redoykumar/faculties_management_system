<template>
    ...
    <div class="q-pa-md">
        <q-table :grid="$q.screen.xs" title="Students" :rows="data.users" :columns="columns" row-key="name"
            ...
            <template v-slot:body-cell-Action="props">
                <q-td :props="props">
                    <div>
                        <router-link to="/ViewStudents" style="text-decoration: none; color: inherit;">
            ...
            <template v-slot:top-right>
                ...
                <router-link to="/AddStudents" style="text-decoration: none; color: inherit;">
...
const columns = [
    ...
    { name: 'Grade', align: 'center',label: 'Last semester grade', field: 'height' },
